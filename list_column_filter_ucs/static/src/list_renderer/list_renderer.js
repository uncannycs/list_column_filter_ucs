...
patch(ListRenderer.prototype, {
    ...
    _injectFilterRow() {
        ...
        if (this.activeActions.onDelete || this.displayOptionalFields) filterRow.appendChild(this._spacerTh());
        if (this.props.onOpenFormView) filterRow.appendChild(this._spacerTh());
